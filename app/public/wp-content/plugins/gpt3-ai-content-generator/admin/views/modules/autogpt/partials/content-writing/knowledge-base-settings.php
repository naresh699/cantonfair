...
<div class="aipkit_vector_settings_redesigned">
                ...
                <div class="aipkit_vector_toggle_row">
                    ...
                    <div class="aipkit_vector_toggle_controls">
                        <label class="aipkit_switch">
                            <input
                                type="checkbox"
                                id="aipkit_task_cw_enable_vector_store"
                                name="enable_vector_store"
                                class="aipkit_toggle_switch aipkit_cw_vector_store_toggle aipkit_task_cw_vector_store_toggle"
                                value="1"
                            >
    ...
    <div class="aipkit_vector_settings_chunk aipkit_vector_settings_chunk--source aipkit_cw_vector_store_settings_container aipkit_task_cw_vector_store_settings_container" style="display:none;">
        <div class="aipkit_vector_settings_chunk_body">
            <div class="aipkit_vector_source_selector">
                <div class="aipkit_vector_source_row">
                    <label class="aipkit_vector_settings_label" for="aipkit_task_cw_vector_store_provider">
                        <?php esc_html_e('Provider', 'gpt3-ai-content-generator'); ?>
                    </label>
                    <select
                        id="aipkit_task_cw_vector_store_provider"
                        name="vector_store_provider"
                        class="aipkit_vector_settings_select aipkit_autosave_trigger aipkit_cw_vector_store_provider_select aipkit_task_cw_vector_store_provider_select"
                    >
                ...
                <div class="aipkit_vector_source_row aipkit_vector_source_row--store">
                    <div class="aipkit_cw_vector_openai_field aipkit_task_cw_vector_openai_field">
                        <label class="aipkit_vector_settings_label" for="aipkit_task_cw_openai_vector_store_ids">
                        ...
                        >
                            <button
                                ...
                                aria-expanded="false"
                                aria-controls="aipkit_task_cw_openai_vector_store_panel"
                            >
                            ...
                            <div
                                id="aipkit_task_cw_openai_vector_store_panel"
                        ...
                        <select
                            id="aipkit_task_cw_openai_vector_store_ids"
                    ...
                    <div class="aipkit_cw_vector_pinecone_field aipkit_task_cw_vector_pinecone_field" style="display:none;">
                        <label class="aipkit_vector_settings_label" for="aipkit_task_cw_pinecone_index_name">
                            <?php esc_html_e('Index', 'gpt3-ai-content-generator'); ?>
                        </label>
                        <select
                            id="aipkit_task_cw_pinecone_index_name"
                    ...
                    <div class="aipkit_cw_vector_qdrant_field aipkit_task_cw_vector_qdrant_field" style="display:none;">
                        <label class="aipkit_vector_settings_label" for="aipkit_task_cw_qdrant_collection_name">
                            <?php esc_html_e('Collection', 'gpt3-ai-content-generator'); ?>
                        </label>
                        <select
                            id="aipkit_task_cw_qdrant_collection_name"
    ...
    <div class="aipkit_vector_settings_chunk aipkit_vector_settings_chunk--embedding aipkit_cw_vector_store_settings_container aipkit_task_cw_vector_store_settings_container aipkit_cw_vector_embedding_config_row aipkit_task_cw_vector_embedding_config_row" style="display:none;">
        <div class="aipkit_vector_settings_chunk_body">
            <div class="aipkit_vector_embedding_selector">
                <div class="aipkit_vector_embedding_row">
                    <label class="aipkit_vector_settings_label" for="aipkit_task_cw_vector_embedding_provider">
                        <?php esc_html_e('Embed Provider', 'gpt3-ai-content-generator'); ?>
                    </label>
                    <select
                        id="aipkit_task_cw_vector_embedding_provider"
                ...
                <div class="aipkit_vector_embedding_row aipkit_vector_embedding_row--model">
                    <label class="aipkit_vector_settings_label" for="aipkit_task_cw_vector_embedding_model">
                        <?php esc_html_e('Model', 'gpt3-ai-content-generator'); ?>
                    </label>
                    <select
                        id="aipkit_task_cw_vector_embedding_model"
                        name="vector_embedding_model"
                        class="aipkit_vector_settings_select aipkit_autosave_trigger aipkit_cw_vector_embedding_model_select aipkit_task_cw_vector_embedding_model_select"
                    >
    ...
    <div class="aipkit_vector_settings_chunk aipkit_vector_settings_chunk--retrieval aipkit_vector_settings_chunk--collapsible aipkit_cw_vector_store_settings_container aipkit_task_cw_vector_store_settings_container" style="display:none;">
        <button type="button" class="aipkit_vector_settings_chunk_header aipkit_vector_settings_chunk_header--collapsible" aria-expanded="false" aria-controls="aipkit_task_cw_retrieval_options_body">
        ...
        <div class="aipkit_vector_settings_chunk_body aipkit_vector_settings_chunk_body--collapsible" id="aipkit_task_cw_retrieval_options_body" aria-hidden="true">
            <div class="aipkit_vector_slider_group">
                <div class="aipkit_vector_slider_header">
                    <label class="aipkit_vector_settings_label" for="aipkit_task_cw_vector_store_top_k">
                        <?php esc_html_e('Results Limit', 'gpt3-ai-content-generator'); ?>
                    </label>
                    <span class="aipkit_vector_slider_value" id="aipkit_task_cw_vector_store_top_k_value">3</span>
                </div>
                <div class="aipkit_vector_slider_wrapper">
                    ...
                    <input
                        type="range"
                        id="aipkit_task_cw_vector_store_top_k"
