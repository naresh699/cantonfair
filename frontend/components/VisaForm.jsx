...
export default function VisaForm({
    ...
    if (status === 'success') {
        ...
        return (
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-full">
                <div className="bg-dragon-blue text-white p-8 md:p-12 md:w-2/5">
                    ...
                    <div className="space-y-4">
                        {features.map((feature, index) => (
                            <div key={index} className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded-full bg-dragon-red flex items-center justify-center text-sm">✓</div>
                                <span className="text-sm">{feature}</span>
                            </div>
                        ))}
                    </div>
                </div>
                <div className="p-8 md:p-12 md:w-3/5 flex items-center justify-center">
                    <div className="bg-green-50 p-6 rounded-xl border border-green-200 text-center w-full">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-lg font-bold hover:bg-[#20bd5a] transition-colors mb-4 mx-auto shadow-md w-full justify-center"
                        >
